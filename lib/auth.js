/*
  ...
  verifyAuth() : permet de proteger nos pages en verifiant si l'utilisateur est authentifie. si l'utilisateur n'est pas authentifie, nous le redirigerons vers la page de connexion. si l'utilisateur est authentifie, nous lui permettrons d'acceder a la page protegee
 */
...
// detruire la section de l'utilisateur
export async function destroySession() {
  ...
  // detruire une session: l'invalider et effacer le cookie
